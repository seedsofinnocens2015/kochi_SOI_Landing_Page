  ...
  const doctors = [
    {
      ...
      location: 'Kochi, GHAZIABAD',
      image:
        '/gads/nov25/kochi/Images/Dr Gauri maam.webp',
  ...
  const centers = [
    {
      name: 'Kochi',
      city: 'Kerala',
      image: '/gads/nov25/kochi/Images/Kochi1.webp',
      address:
        'Opp Royal drive showroom, land mark near SBI Bank, Kannadikadu, Upasana Rd, Kundannoor, Maradu, Kochi, Kerala 682304',
      mapLink:
        'https://www.google.com/maps/place/Seeds+of+Innocens+IVF+Centre+Kochi+%7C+Best+IVF+Centre+In+Kochi/@9.9499109,76.3163241,17z/data=!4m10!1m2!2m1!1sSeeds+of+Innocens+IVF+Centre+Kochi+%7C+Best+IVF+Centre+In+Kochi,+Opp+Royal+drive+showroom,+land+mark+near+SBI+Bank,+Kannadikadu,+Upasana+Rd,+Kundannoor,+Maradu,+Kochi,+Kerala+682304!3m6!1s0x3b0873e543bf1fdf:0xbd8788c104a545ad!8m2!3d9.9499056!4d76.318899!!16s%2Fg%2F11xvxdfrr9?entry=ttu&g_ep=EgoyMDI1MTEwNC4xIKXMDSoASAFQAw%3D%3D',
    },
    {
      name: 'Kasaragod',
      city: 'Kerala',
      image: '/gads/nov25/kochi/Images/Kasaragod.webp',
      address: 'Bank Rd, Kasaragod, Kerala, 671121',
      mapLink: 'https://www.google.com/maps/place/Seeds+of+Innocens+IVF+Centre+-+Best+IVF+Centre+in+Kasaragod,+Kerala/@12.505438,74.9829914,17z/data=!3m1!4b1!4m6!3m5!1s0x3ba48385b1be962d:0xbcc6ed4e1e0762c1!8m2!3d12.5054328!4d74.9878623!16s%2Fg%2F11w3zmmvkk?entry=ttu&g_ep=EgoyMDI1MTEwNC4xIKXMDSoASAFQAw%3D%3D',
    },
  ]
  ...
  const testimonials = [
    {
      ...
      videoId: 'CAXcbJE6RKo',
      link: 'https://www.youtube.com/watch?v=CAXcbJE6RKo',
    },
    {
      stars: 5,
      text:
      ...
      videoId: 'VelcYrUnm2s',
      link: 'https://www.youtube.com/watch?v=VelcYrUnm2s',
    },
    {
      stars: 5,
      text:
        'Thanks for Seeds of Innocence Team. Seeds of innocence team ka work bhout hi achha h. Hme first time m hi success mili. Price k according facilities kafi achhi h. special thanks to Lisha maam',
      videoId: 'vef8hud-6kU',
      link: 'https://www.youtube.com/watch?v=vef8hud-6kU',
    },
    {
      stars: 5,
      text:
      ...
      videoId: 'qSRIG9kd3HY',
      link: 'https://www.youtube.com/watch?v=qSRIG9kd3HY',
    },
  ]
      ...
      <header className="fixed top-0 left-0 right-0 w-full bg-white z-50 shadow-lg">
        <div className="mx-auto max-w-7xl flex items-center justify-start sm:justify-between gap-35 px-2 py-1">
          ...
          <a href="/" className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            <img
              src="/gads/nov25/kochi/Images/SOILogo.webp"
          ...
          <div className="flex flex-col items-start sm:items-center gap-1 w-auto sm:w-[210px] ml-0 sm:ml-0 flex-shrink-0">
            ...
            >
              <span className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 inline-flex items-center justify-center rounded-full bg-white shadow">
                <img
                  src="/gads/nov25/kochi/Images/whatsapp_PNG20 1.webp"
                  alt="WhatsApp"
      ...
      <div className="pt-[45px] sm:pt-[65px]">
            ...
            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/IUI, IVF & ICSI.webp"
                    alt="IUI, IVF & ICSI"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/Blastocyst.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/Cryopreservation.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/PRP & Ovarian.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/Genetic testing.webp"
                    alt="Genetic Testing"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <img
                    src="/gads/nov25/kochi/Images/Genetic.webp"
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/TESA PESA.webp"
                    alt="TESA/PESA"
                    className="w-16 h-16 sm:w-20 sm:h-20 object-contain"
                    loading="lazy"
                  />
              ...
              <div className="bg-white rounded-sm p-4 sm:p-6 shadow-sm border border-gray-200 text-center transition duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:scale-[1.04] group">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  <img
                    src="/gads/nov25/kochi/Images/Laparoscopy &.webp"
              ...
              {[
                {
                  ...
                  desc:
                    "With over 35 IVF centres across the National and International, Seeds of Innocens brings fertility care closer to you. Whether you're in a metro or a smaller city, expert help is never far away. Visit your nearest centre and take the first step toward parenthood with us.",
                  icon: (
                    <img src="/gads/nov25/kochi/Images/08.webp" alt="35+ IVF Centres" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '20,000+ Healthy Babies',
                  desc:
                    'At Seeds of Innocens, we are proud to have helped over 20,000 families welcome healthy babies into the world. Our commitment to quality fertility care and personalised treatment has made us a trusted name in IVF.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/01.webp" alt="20,000+ Healthy Babies" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Upto 78% Success Rate',
                  desc:
                    'We maintain an impressive IVF success rate of 78%, higher than the average. Our advanced lab technology and individualised treatment plans make this possible. We believe in transparency, trust, and results that matter.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/03.webp" alt="Upto 78% Success Rate" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: '30+ Certified Trained Clinicians',
                  desc:
                    'Our team includes over 30 certified and highly trained fertility specialists and embryologists. With years of experience and global expertise, we offer world-class treatment and compassionate care.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/06.webp" alt="30+ Certified Trained Clinicians" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Affordable IVF Care',
                  desc:
                    'We provide affordable IVF treatment and offer quality services to patients, with customised packages and financing options to make your journey easier.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/02.webp" alt="Affordable IVF Care" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Fetal Medicine',
                  desc:
                    'We offer fetal medicine services including ultrasound scans, fetal echocardiography, and diagnostic procedures like amniocentesis and CVS for comprehensive prenatal care.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/04.webp" alt="Fetal Medicine" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'Expert Fertility Counsellor & Clinical Geneticist',
                  desc:
                    'Genetic counselors evaluate family histories and identify potential genetic risks that could affect reproductive outcomes, guiding you with options and implications of results.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/05.webp" alt="Expert Fertility Counsellor & Clinical Geneticist" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
                {
                  title: 'In-House Genetic Lab',
                  desc:
                    'We are the first IVF centre in India to establish an in-house genetic lab with testing services including PGT-A which increases the success rate of the IVF process.',
                  icon: (
                    <img src="/gads/nov25/kochi/Images/07.webp" alt="In-House Genetic Lab" className="h-14 w-14 object-contain" loading="lazy" />
                  ),
                },
              ].map((f, idx) => (
                <div
        ...
        <section className="w-full bg-gray-100 py-8 sm:py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {/* Main Heading */}
            <h2 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-4 sm:mb-6">
              About Seeds of Innocens IVF Centre Kerala
            </h2>
            <div className="p-4">
              {/* Kochi Centers Mobile Grid */}
              <div className="sm:hidden mt-4">
                <div className="grid grid-cols-2 gap-3">
                  {centers.map((center) => (
                    <div
              ...
              {/* Kochi Centers Grid (Tablet/Desktop) */}
              <div className="hidden sm:grid grid-cols-1 mt-20 sm:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-8 mb-10">
                {centers.map((center) => (
                  <div
                    key={center.name}
                    className="flex flex-col items-center text-center group transition-all duration-300"
              ...
              <div className="flex-1 flex flex-col items-center justify-center lg:justify-start mt-7 lg:mt-0">
                <div className="text-center text-gray-800 text-sm sm:text-base leading-6 max-w-5xl mx-auto mb-8 sm:mb-10 lg:mb-12 px-2 space-y-4">
                  ...
                  <p>
                    The team of experts at Seeds of Innocens IVF in Kochi includes exceptional professionals such as consultant fertility specialists, sonographers, embryologists, nurses, and counsellors who collaborate to provide the highest quality treatment in a caring and nurturing environment.
                  </p>
                  <p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center">
              <h3 className="font-bold text-xl sm:text-2xl text-gray-900 leading-snug text-center">
                Seeds of Innocens - Best IVF Centre in Kochi | Fertility Clinics
              </h3>
              <div className="mt-8 space-y-6 flex flex-col items-center justify-center">
                ...
                <div className="flex items-center gap-3 justify-center">
                  ...
                  <p className="text-basFe sm:text-lg text-gray-900 text-center">
