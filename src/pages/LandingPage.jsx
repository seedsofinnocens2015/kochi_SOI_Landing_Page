                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-base sm:text-lg text-gray-900">
                      ...
                      </span> Opp Royal drive showroom, land mark near SBI Bank, Kannadikadu, Upasana Rd, Kundannoor, Maradu, Kochi, Kerala 682304
                    </p>
                  </div>
                </div>
                <div className="mt-5 flex flex-wrap gap-3">
                  <a href="https://www.google.com/maps/place/Seeds+of+Innocens+IVF+Centre+Kochi+%7C+Best+IVF+Centre+In+Kochi,+Opp+Royal+drive+showroom,+land+mark+near+SBI+Bank,+Kannadikadu,+Upasana+Rd,+Kundannoor,+Maradu,+Kochi,+Kerala+682304/@9.949911,76.316324,17z/data=!4m6!3m5!1s0x3b0873e543bf1fdf:0xbd8788c104a545ad!8m2!3d9.949911!4d76.316324!16s%2Fg%2F11c0f8zqk9?entry=ttu&g_ep=EgoyMDI1MTAyOC4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-red-700 transition-colors">
